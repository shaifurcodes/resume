...
Inventor on 4 US patents; 8 peer-reviewed publications (200+ citations, h-index 7).
...
\begin{tabularx}{\linewidth}{@{}>{\bfseries}p{3.7cm}X@{}}
Robotics & ROS 2, Gazebo, Nav2, OpenCV, SLAM, Sensor Fusion (LiDAR+IMU), Wheel Odometry.
\\[2pt]
Sim2Real & MuJoCo playground, Lerobot, Isaac Lab
\\[2pt]
Embodied AI \& ML & VLA, VLM \& Edge LLM Deployment (Gemma, smolVLA on Jetpack), {Imitation/Reinforcement} Learning, Hugging Face Hub integration, Llama.cpp
\\[2pt]
Embedded Systems & C/C++, Python, Firmware, Low-level programming, Latency Optimization, wireless protocols, Linux Systems, SPI/I2C/Serial/CAN etc. interfaces
\\[2pt]
Hardware \& Edge & NVIDIA Jetson Orin, 6-DOF Arms (SO-101), RPLIDARs, IMX Cameras, IMUs, 520 Motor Encoders, STS Servo motors
\\[2pt]
Prototype Design & FreeCAD, OpenSCAD, KiCAD
\\[2pt]
Robotic CI/CD & Industrial\_CI+GitHub-Action, Regression test, HIL-test
